...
} from "@/lib/repository/user/forgot_password_repository";
import {
...
import {
    IUserRepository,
    UserRepository,
} from "@/lib/repository/user/user_repository";

export class RepositoryFactory {
    constructor(private readonly connection: Connection) {}

    get forgotPassword(): IForgotPasswordRepository {
        return this.connection.getCustomRepository<ForgotPasswordRepository>(
            ForgotPasswordRepository,
        );
    }
    ...
    get emailConfirmation(): IEmailConfirmationRepository {
        return this.connection.getCustomRepository<EmailConfirmationRepository>(
            EmailConfirmationRepository,
        );
    }
}
